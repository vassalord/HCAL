...
double HOSample::allFC()     {return m_collection -> GetData() -> HODigiAllFC     -> at(m_raw_index)[m_timeslice];}
double HOSample::energy()    {return m_collection -> GetData() -> HODigiEnergy    -> at(m_raw_index)[m_timeslice];}
double HOSample::gain()      {return m_collection -> GetData() -> HODigiGain      -> at(m_raw_index)[m_timeslice];}
double HOSample::fc()        {return m_collection -> GetData() -> HODigiFC        -> at(m_raw_index)[m_timeslice];}
double HOSample::nomFC()     {return m_collection -> GetData() -> HODigiNomFC     -> at(m_raw_index)[m_timeslice];}
double HOSample::pedFC()     {return m_collection -> GetData() -> HODigiPedFC     -> at(m_raw_index)[m_timeslice];}
double HOSample::rcGain()    {return m_collection -> GetData() -> HODigiRCGain    -> at(m_raw_index)[m_timeslice];}
