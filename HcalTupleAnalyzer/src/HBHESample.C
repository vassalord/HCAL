...
double HBHESample::allFC()     {return m_collection -> GetData() -> HBHEDigiAllFC     -> at(m_raw_index)[m_timeslice];}
double HBHESample::energy()    {return m_collection -> GetData() -> HBHEDigiEnergy    -> at(m_raw_index)[m_timeslice];}
double HBHESample::gain()      {return m_collection -> GetData() -> HBHEDigiGain      -> at(m_raw_index)[m_timeslice];}
double HBHESample::fc()        {return m_collection -> GetData() -> HBHEDigiFC        -> at(m_raw_index)[m_timeslice];}
double HBHESample::nomFC()     {return m_collection -> GetData() -> HBHEDigiNomFC     -> at(m_raw_index)[m_timeslice];}
double HBHESample::pedFC()     {return m_collection -> GetData() -> HBHEDigiPedFC     -> at(m_raw_index)[m_timeslice];}
double HBHESample::rcGain()    {return m_collection -> GetData() -> HBHEDigiRCGain    -> at(m_raw_index)[m_timeslice];}
