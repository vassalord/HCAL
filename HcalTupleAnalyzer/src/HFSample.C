...
double HFSample::allFC()     {return m_collection -> GetData() -> HFDigiAllFC     -> at(m_raw_index)[m_timeslice];}
double HFSample::energy()    {return m_collection -> GetData() -> HFDigiEnergy    -> at(m_raw_index)[m_timeslice];}
double HFSample::gain()      {return m_collection -> GetData() -> HFDigiGain      -> at(m_raw_index)[m_timeslice];}
double HFSample::fc()        {return m_collection -> GetData() -> HFDigiFC        -> at(m_raw_index)[m_timeslice];}
double HFSample::nomFC()     {return m_collection -> GetData() -> HFDigiNomFC     -> at(m_raw_index)[m_timeslice];}
double HFSample::pedFC()     {return m_collection -> GetData() -> HFDigiPedFC     -> at(m_raw_index)[m_timeslice];}
double HFSample::rcGain()    {return m_collection -> GetData() -> HFDigiRCGain    -> at(m_raw_index)[m_timeslice];}
