...
// used to generate this class and read the Tree.
   if (tree == 0) {
    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("file:/eos/user/s/shoienko/HcalTupleMaker/HcalTupleMaker_3668_6.root");
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/user/s/shoienko/HcalTupleMaker/HcalTupleMaker_363427_uHTR_2_7_4.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/user/s/shoienko/HcalTupleMaker/HcalTupleMaker_3668_6.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/user/s/shoienko/HcalTupleMaker/HcalTupleMaker_3668_6.root:/hcalTupleTree");
