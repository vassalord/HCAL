...
class baseClass {
 ...
 public:
  ...
  TProfile* makeTProfile(const char * name, int nbins , float xmin, float xmax);
  TProfile* makeTProfile(const char * name, const char * title, int nbins , float xmin, float xmax);
